...
// 2026-09-05 起常驻扩展只有两份文件:lop-pretool.ts(确定性工具前修复)与 lop-followup.ts(默认关闭的追问模式)。
// 旧 lop-chain.ts / lop-swarm / browser-agent junction 已退役,本脚本不再创建,发现残留只报告不动手。
...
const RETIRED = ["lop-chain.ts", "lop-swarm", "browser-agent"];
